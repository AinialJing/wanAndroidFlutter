...
Map<String, dynamic> _$HomeListEntityToJson(HomeListEntity instance) =>
    <String, dynamic>{
      'data': instance.data,
...
HomeListData _$HomeListDataFromJson(Map<String, dynamic> json) => HomeListData()
  ..curPage = json['curPage'] as int
  ..datas = (json['datas'] as List<dynamic>)
      .map((e) => HomeListDataItem.fromJson(e as Map<String, dynamic>))
      .toList()
...
HomeListDataItem _$HomeListDataItemFromJson(Map<String, dynamic> json) =>
    HomeListDataItem()
...
Map<String, dynamic> _$HomeListDataItemToJson(HomeListDataItem instance) =>
    <String, dynamic>{
